...
function processSingleSlide(zip, sldFileName, index, slideSize) {
    ...
    var bgColor = getSlideBackgroundFill(slideContent, slideLayoutContent, slideMasterContent);
          // Add a textbox at the end of the section
    var chatGPTContent = '生成中...'; // Replace this with the actual content
    var result = "<div class='slide-content' data-text-index='" + slideIndex + "'>" +
    ...
    // Inside the loop or function where you build each slide's HTML
    result += "<section class='slide' data-slide-index='" + slideIndex + "' style='width:" + slideSize.width + "px; height:" + slideSize.height + "px; background-color: #" + bgColor + "'>";
