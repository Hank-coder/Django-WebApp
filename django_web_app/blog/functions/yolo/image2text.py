...
import os
from django_web_app.blog.functions.utils import extract_exif_info
# Generate the message
from django_web_app.blog.functions.image_audio_generate.gpt_generate import generate_system_message
